ALTER TABLE TargetActivity DROP FOREIGN KEY `TargetActivity_club_id_fkey`;
ALTER TABLE Documents DROP FOREIGN KEY `Document_activity_id_fkey`;
ALTER TABLE Activity DROP FOREIGN KEY `Activity_club_id_fkey`;
ALTER TABLE Activity DROP FOREIGN KEY `Activity_category_id_fkey`;
ALTER TABLE Roles DROP FOREIGN KEY `Roles_user_id_fkey`;
ALTER TABLE Roles DROP FOREIGN KEY `Roles_position_id_fkey`;
ALTER TABLE Images DROP FOREIGN KEY `Images_document_id _fkey`;
ALTER TABLE Video DROP FOREIGN KEY `Video_document_id _fkey`;
ALTER TABLE Pdf DROP FOREIGN KEY `Pdf_document_id _fkey`;
ALTER TABLE Student DROP FOREIGN KEY `Student_user_id_fkey`;
ALTER TABLE Student DROP FOREIGN KEY `Student_club_id_fkey`;
...
DROP TABLE if exists TargetActivity;
...
-- ADD WEBMASTER
insert into Users(user_uuid, username, email, password) values("3ddb0697-bcf3-4457-a3cd-2878f7ee53e5", "Hairyblue", "Hairyblue@cjc.com", "$2b$12$O/EVmQr50yW7j.RgOUerfO4XVSI8YdPihwOOb9d7KcMZ2z/yo6jMq");
insert into Roles(user_id , level_id) values (1, 1);

-- ADD ADMIN
insert into Users(user_uuid, username, email, password) values("fc9fb5ba-dc7f-4a09-a280-43aa4c3c5700", "plazacjc", "louellamayplaza@g.cjc.edu.ph", "$2b$12$8Fdnltnfd3izro2B9/mAkuN5rqESZzYYlQ3wEA8gZZfDKXWcxcBRC");
insert into Roles(user_id , level_id) values (2, 2);

-- ADD STUFF IF IN CASE
insert into Users(user_uuid, username, email, password) values("c6f968c8-9d2b-4cc3-ae14-756ae4be599f", "staffcjc", "staff@cjc.com", "$2b$12$m.p/POU/eufam9pb0iKEZOBb1weiZOw8rHpJ13OFKNfhF7VatFUKO");
insert into Roles(user_id , level_id) values (3, 3);

-- ADD TEMP STUDENT
insert into Users(user_uuid, username, email, password) values("3d0df7c0-afd6-47ae-aa9a-ceffd1520778", "student", "student@cjc.com", "$2b$12$oMyFfeMjhM8Z3Y3n3Sjgw.HNec6aQunuFwQFn9AvKKMQZNQwksSBK");
insert into Roles(user_id , level_id) values (4, 4);
insert into Student(student_user_id, club_id, schoolYear, student_uuid) values(4, 1, "2024-2025", "00fff055-45c7-4b4c-bb2a-e2383c78a5a9");
