...
-- ALTER TABLE Documents DROP FOREIGN KEY `Document_activity_same_record_uuid_fkey`;
...
create table if not exists Activity(
    ...
    activity_same_record_uuid varchar(255) not null,
    ...
    activityPersonel LONGTEXT null,
    activityNumberParticipants int DEFAULT 0,
    activityModality enum("On-Campus", "Off-Campus", "Online"),
    activityStatus enum("APPROVED", "DISAPPROVED", "PENDING") DEFAULT "PENDING",
    activityComments LONGTEXT null,
...
create table if not exists Documents(
    ...
    document_activity_same_uuid VARCHAR(255) not null,
...
-- ADD WEBMASTER
insert into Users(user_uuid, username, email, password) values("3ddb0697-bcf3-4457-a3cd-2878f7ee53e5", "Webmaster", "Webmaster@sample.com", "$2a$12$riUKer3pHL3sR4gHdqo.lOCivnmaKd6SJ2XiU4WX3ht1YHYzf/iwe");
...
CREATE INDEX idx_activity_same_record_uuid ON Activity (activity_same_record_uuid);

-- ALTER TABLE Documents ADD CONSTRAINT `Document_activity_same_record_uuid_fkey` FOREIGN KEY (document_activity_same_uuid) REFERENCES Activity (activity_same_record_uuid) on DELETE CASCADE on UPDATE CASCADE;
