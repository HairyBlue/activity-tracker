  ...
  <div v-if="renderComponent">
    <div>
      <div class="h-screen overflow-auto border border-r-gray-300 p-2">
        <div>
          <h2 class="text-base font-semibold leading-7 text-gray-900">Form Submition Activity</h2>
          ...
          <div class="mt-4 flex flex-col gap-x-6 gap-y-4">
            ...
            <div>
              ...
              <div class="h-64 w-full overflow-y-auto rounded-lg border border-gray-200 bg-white p-6">
