        ...
        <div class="flex flex-col gap-2">
          ...
          <div class="card w-full bg-base-100 shadow-xl">
            <div class="card-body">
              ...
              <p>When updating, all assoiciate to this data will be affected or updated.</p>
            </div>
          </div>
          <div class="card w-full bg-base-100 shadow-xl">
            <div class="card-body">
              <h2 class="card-title underline">Deleting data</h2>
              <p>When Deleting all assoiciate to this data will be deleted. This can be recover on archive section.</p>
            </div>
          </div>
        </div>
