...
if [[ "$name" == "attachments" ]]; then
   ...
   echo "Usage:"
   echo "     attachments     - Copy attachements from [./back/attachments] to [./server/dist/attachements]"
   echo "     mysql           - MYSQL from [./back/sqldump] latest file to MYSQL DATABASE"
fi
